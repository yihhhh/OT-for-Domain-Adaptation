...
def cli_main(config_file='config', group_id='group', exp_id='exp', mode='formal'):
    ...
    if ot_args.train_model:
        ...
        train_ot_plan(src_split, dst_split, ot_args, ot_src_sampler, ot_dst_sampler, ot_planner, ot_optimizer, device=device)
...
def train_ot_plan(src_split, dst_split, args, source_sampler, target_sampler, ot_planner, optimizer, device):
